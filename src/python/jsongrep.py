...
## DESCRIPTION: jsongrep.py – Python for extracting pieces of JSON objects
##     Lots of APIs these days return JSON objects. I love JSON, but reading a 
##     raw JSON dump can be awkward. You can print the whole thing using pprint
##     in Python (or your favorite language), but what if you want to grep out 
##     and print only parts of the JSON? I was thinking tonight that it would 
##     be easy and useful to write a recursive script to do that.
## DOWNLOADED: 2013-01-27
