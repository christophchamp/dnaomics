...
from calc_statistics_resampling import calc_statistics_resampling
...
def exec_go_pipeline(abund_file, metadata_file, pathway_file, stats_file,
    ...
    go_list, err = calc_statistics(abund_file, metadata_file, 
                                   stats_file,
    ...
    ## Calculate various statistics on abund_file with resampling
    go_list, err = calc_statistics_resampling(abund_file, metadata_file, 
                                              stats_file,
                                              control_id, AVAILABLE_STATISTICS)
